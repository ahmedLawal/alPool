...
- Normalize model echo on the NON-STREAMING path too
...
- Drop unused FIVE_H constant (lint)
- Fast-refill discount extends to the in-flight terms (concurrency + capPenalty)
